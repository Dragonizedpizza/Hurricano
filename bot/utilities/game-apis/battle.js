...
import Button from "../../utilities/ButtonMenu.js";
...
async function createBattle(member, message) {
    ...
    async function start(member, message) {
        const msg = await message.channel.sendSuccess(message, "Battle!", `Hey ${member}! ${message.author} has challenged you to a battle, do you accept?`, null, null, [
            [
            ...
            setSettings.on("collect", async (msg) => {
                ...
                if (args[0] === "heal" && args[1] && args[2] && !isNaN(args[2] && args[2] <= 200 && args[2] >= 2)) {
                    ...
                    const emb7 = new MessageEmbed()
                        .setTitle("Battle!")
                        .setDescription(`First Player: ${message.author} \`HP: ${playerOneData.battleHealth}\`\nSecond Player: ${member} \`HP: ${playerTwoData.battleHealth}\`\n\nAttacks: \`${attacks.join(", ")}\`\nHealing: \`${heals.join(", ")}\`\n\nUse \`--end\` on your turn to end`)
                        .setColor("RED")
    ...
    async function first(member, message) {
        ...
        if (playerOneData.battleTurn === true)
            return;
                ...
                if (msg.content.toLowerCase() === attacks[i]) {
                    ...
                    if (chance[attackChance] === "yes") {
                        ...
                        const emb8 = new MessageEmbed()
                            .setDescription(`${nowBattling} used **${attacks[i]}** to do \`${attackAmount}\` damage to ${nextUp}, they have \`${playerTwoData.battleHealth}\` HP Left!`)
                            .setColor("RED")
                        ...
                        const emb9 = new MessageEmbed()
                            .setDescription(`${nowBattling} used **${attacks[i]}** against ${nextUp}, but it was unsuccessful, they still have \`${playerTwoData.battleHealth}\` HP Left!`)
                            .setColor("RED")
                            .setAuthor(`Attack by: ${nowBattling.displayName}`, nowBattling.user.displayAvatarURL())
                            .setFooter(`Next up: ${nextUp.displayName}`, nextUp.user.displayAvatarURL());
                        await message.channel.send({
                ...
                if (msg.content.toLowerCase() === heals[x]) {
                    ...
                    if (chance[healChance] === "yes") {
                        ...
                        const emb10 = new MessageEmbed()
                            .setDescription(`${nowBattling} used **${heals[x]}** and healed \`${healAmount}\` HP, they now have \`${playerOneData.battleHealth}\` HP!`)
                            .setColor("GREEN")
                        ...
                        const emb11 = new MessageEmbed()
                            .setDescription(`${nowBattling} used **${heals[x]}** but it was unsuccessful, they still have \`${playerTwoData.battleHealth}\` HP!`)
                            .setColor("GREEN")
                            .setAuthor(`Heal by: ${nowBattling.displayName}`, nowBattling.user.displayAvatarURL())
                            .setFooter(`Next up: ${nextUp.displayName}`, nextUp.user.displayAvatarURL());
                        await message.channel.send({
    ...
    async function second(member, message) {
        ...
        let collector = message.channel.createMessageCollector({ filter });
        if (playerTwoData.battleTurn === true)
            return;
                ...
                if (msg.content.toLowerCase() === attacks[i]) {
                    ...
                    if (chance[attackChance] === "yes") {
                        ...
                        const emb12 = new MessageEmbed()
                            .setDescription(`${nowBattling} used **${attacks[i]}** to do \`${attackAmount}\` damage to ${nextUp}, they have \`${playerOneData.battleHealth}\` HP Left!`)
                            .setColor("RED")
                            .setAuthor(`Attack by: ${nowBattling.displayName}`, nowBattling.user.displayAvatarURL())
                            .setFooter(`Next up: ${nextUp.displayName}`, nextUp.user.displayAvatarURL());
                        await message.channel.send({
                ...
                if (msg.content.toLowerCase() === heals[x]) {
                    ...
                    if (chance[healChance] === "yes") {
                        ...
                        const emb14 = new MessageEmbed()
                            .setDescription(`${nowBattling} used **${heals[x]}** and healed \`${healAmount}\` HP, they now have \`${playerTwoData.battleHealth}\` HP!`)
                            .setColor("GREEN")
                            .setAuthor(`Heal by: ${nowBattling.displayName}`, nowBattling.user.displayAvatarURL())
                            .setFooter(`Next up: ${nextUp.displayName}`, nextUp.user.displayAvatarURL());
                        await message.channel.send({
